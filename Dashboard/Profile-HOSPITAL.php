                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-12 col-lg-3 mb-4">
                                            ...
                                            <select id="cadre" class="sweetselect" data-default="<?php echo $cadre;?>">
                                                <option disabled selected value="">Select a Cadre</option>
                                    ...
                                    <button type="submit" class="btn btn-primary waves-effect waves-light updateprofile_hospital blue">Update Profile</button>
                                </div>
                            </div>
                        </div>
