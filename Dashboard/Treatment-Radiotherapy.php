...
?>
                    ...
                    <div class="row d-none">
                        <div class="col-12">
                            <div class="page-title-box d-flex justify-content-between flex-column">
                                <h2 class="mb-0 snt font-weight-bold">Log Radiotherapy</h2>
                                <br>
                                <h5 class="mb-0 snt font-size-15 font-weight-normal" style="color: #666">Log your radiotherapy here. Click on a day to begin</h5>
                        ...
                        <div class="card m-0" style="flex: 1; height: 100vh; box-shadow: none">
                            <div class="card-body">
                                ...
                                <div class="side_effect_items" style="display: none">
                                    ...
                                    <!-- <p class="card-title font-size-20 mb-2 current-state align-center" style="text-transform: none">Log Radiotherapy</p> -->
                                    <h5 class="mb-4 snt font-size-15 font-weight-normal sub-state" style="color: #000">No radiotherapy has been logged today. Log them below</h5>
                                    ...
                                    <div class="t2b as_sheet">
                                        ...
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Target site</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter target site here" id="target_site">
                                            </div>
                                        </div>
    
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Field type</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter field type here" id="field_type">
                                            </div>
                                        </div>
    
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Number of fields</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter number of fields here" id="number_of_fields">
                                            </div>
                                        </div>
    
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Size of fields</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter size of fields here" id="size_of_fields">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Total dose</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter total dose here" id="total_dose">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Number of fractions</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter number of fractions here" id="number_of_fractions">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Size of fractions</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter size of fractions here" id="size_of_fractions">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Number of weeks</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter number of weeks here" id="number_of_weeks">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Fractionation regimen</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter fractionation regimen here" id="fractional_regimen">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Conventional</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter conventional here" id="conventional">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Hypofractionation</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter hypofractionation here" id="hypofractionation">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Hyperfractionation</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter hyperfractionation here" id="hyperfractionation">
                                            </div>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Other</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter other here" id="other">
                                            </div>
                                        </div>
    
    
                                        <div class="mt-3 drop_d to_remove type_female_pelvic">
                                            <label class="i-g-block-label">Radiotherapy intent</label>
                                            <span style=" position: absolute; right: 10px; top: 34px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select visibility_controller" id="intent">
                                        ...
                                        <div class="mt-3 drop_d to_remove type_female_pelvic">
                                            <label class="i-g-block-label">Total dose</label>
                                            <span style=" position: absolute; right: 10px; top: 34px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select visibility_controller" id="dose">
                                                <option value="" selected disabled>Select an option</option>
                                                <option value="40-50 Gy">40-50 Gy</option>
                                                <option value="51-60 Gy">51-60 Gy</option>
                                            </select>
                                        </div>
                                    ...
                                    <button class="btn-primary btn-lg mt-4" id="add-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%);">Log Radiotherapy</button>
                                    <button class="btn-primary btn-lg mt-4" id="update-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%); display: none">Update Radiotherapy</button>
    ...
    <script src="JS/LogRadiotherapy.js"></script>
    <script>
