...
?>
    ...
    <style>
        ...
        <div class="main-content">
            ...
            <div class="page-content p-0" style="padding-bottom: 0; padding-top: 6.8em;">
                    ...
                    <div class="row d-none">
                        <div class="col-12">
                            <div class="page-title-box d-flex justify-content-between flex-column">
                                <h2 class="mb-0 snt font-weight-bold">Log Surgery</h2>
                                <br>
                                <h5 class="mb-0 snt font-size-15 font-weight-normal" style="color: #666">Log your surgery here. Click on a day to begin</h5>
                        ...
                        <div class="card m-0" style="flex: 1; height: 100vh; box-shadow: none">
                            <div class="card-body">
                                ...
                                <div class="side_effect_items" style="display: none">
                                    ...
                                    <!-- <p class="card-title font-size-20 mb-2 current-state align-center" style="text-transform: none">Log Surgery</p> -->
                                    <h5 class="mb-4 snt font-size-15 font-weight-normal sub-state" style="color: #000">No surgery has been logged today. Log them below</h5>
                                    ...
                                    <div class="t2b as_sheet">
                                        ...
                                        <div class="drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Surgery</label>
                                            <span style=" position: absolute; right: 10px; top: 34px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select visibility_controller" id="surgery">
                                        ...
                                        <div class="mt-3 drop_d to_remove type_female_pelvic show_on_change">
                                            <label class="i-g-block-label">Pre-radiotherapy surgery</label>
                                            <span style=" position: absolute; right: 10px; top: 34px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select" id="surgery_pre">
                                                <option value="" selected disabled>Select an option</option>
                                                <option value="No">No</option>
                                                <option value="Yes">Yes</option>
                                            </select>
                                        ...
                                        <div class="mt-3 drop_d to_remove type_breast show_on_change">
                                            <label class="i-g-block-label">Surgery type</label>
                                            <span style=" position: absolute; right: 10px; bottom: 14px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select" id="surgery_type">
                                                <option value="" selected disabled>Select an option</option>
                                                ...
                                                <option value="Breast Conserving Surgery (BCS)">Breast Conserving Surgery (BCS)</option>
                                            </select>
                                        </div>
                                        
                                        <div class="mt-3 drop_d to_remove type_male_pelvic show_on_change">
                                            <label class="i-g-block-label">Surgery type</label>
                                            <span style=" position: absolute; right: 10px; bottom: 14px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select" id="surgery_type">
                                                <option value="" selected disabled>Select an option</option>
                                                ...
                                                <option value="Pelvic Lymphadenectomy">Pelvic Lymphadenectomy</option>
                                                <option value="Transurethral resection of the Prostate (TURP)">Transurethral resection of the Prostate (TURP)</option>
                                                <option value="Inguinal lymph node dissection">Inguinal lymph node dissection</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mt-3 drop_d to_remove type_female_pelvic show_on_change">
                                            ...
                                            <select class="sweetselect sfx_select" id="surgery_type">
                                                <option value="" selected disabled>Select an option</option>
                                                <option value="Total Abdominal Hysterectomy + Bilateral SalpingoOophrectomy (TAH+BSO)">Total Abdominal Hysterectomy + Bilateral SalpingoOophrectomy (TAH+BSO)</option>
                                                <option value="Pelvic Lymphadenectomy">Pelvic Lymphadenectomy</option>
                                                <option value="Trachelectomy">Trachelectomy</option>
                                        ...
                                        <div class="mt-3 drop_d to_remove type_head_and_neck show_on_change">
                                            <label class="i-g-block-label">Surgery type</label>
                                            <span style=" position: absolute; right: 10px; top: 34px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select" id="surgery_type">
                                                <option value="" selected disabled>Select an option</option>
                                                <option value="Excision Biopsy / Wide Local Excision">Excision Biopsy / Wide Local Excision</option>
                                                <option value="Maxillectomy">Maxillectomy</option>
                                                <option value="Tumour resection">Tumour resection</option>
                                                <option value="Cervical lymph node dissection">Cervical lymph node dissection</option>
                                                <option value="other">Others</option>
                                            </select>
                                            <div class="simple_flex mt-2 mb-4" style="display: none">
                                                <input type="text" placeholder="Enter surgery type here" id="surgery_type_other">
                                        ...
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic show_on_change">
                                            <label class="i-g-block-label">Surgery date</label>
                                        ...
                                        <div class="mt-3 drop_d to_remove type_head_and_neck show_on_change">
                                            <label class="i-g-block-label">Notable examination findings at previous clinic visit</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter findings here" id="examination">
                                            </div>
                                        </div>
                                    ...
                                    <button class="btn-primary btn-lg mt-4" id="add-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%);">Log Surgery</button>
                                    <button class="btn-primary btn-lg mt-4" id="update-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%); display: none">Update Surgery</button>
    ...
    <script src="JS/LogSurgery.js"></script>
    <script>
