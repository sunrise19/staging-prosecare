                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM surgery WHERE user_id = '$user_id'";
                            $result = $conn->query($sql);
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    $data .= '<div class="col-12 mb-5 side_effect_group" data-sort="'.strtotime($row['date']).'" data-day="'.$date[0].'" data-month="'.$date[1].'" data-year="'.$date[2].'">';
                                        ...
                                        if(strtolower($cancer) ==  'breast'){
                                            ...
                                            $current_effect = $row['surgery'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="surgery">';
                                                $data .= '<span class="se_title">Surgery</span>';
                                            ...
                                            if(strtolower($current_effect = $row['surgery']) != 'no'){

                                                $current_effect = $row['surgery_type'];
                                                if($current_effect != 'None' && $current_effect != ''){
                                                    $data .= '<div class="col-12 status-'.$current_effect.'" data-type="surgery_type">';
                                                    $data .= '<span class="se_title">Surgery Type</span>';
                                                        $data .= '<span class="se_status">';
                                                        $data .= $current_effect;
                                                        $data .= '</span>';
                                                    $data .= '</div>';
                                                ...
                                                if($current_effect != 'None' && $current_effect != ''){
                                                    ...
                                                    $data .= '<span class="se_title">Surgery Date</span>';
                                                        $data .= '<span class="se_status">';
                                                        $data .= $row['day'] . ' ';
                                                        $data .= $row['month'] . ', ';
                                                        $data .= $row['year'];
                                            ...
                                            if(strtolower($current_effect = $row['surgery']) != 'no'){
                                                ...
                                                $current_effect = $row['examination'];
                                                if($current_effect != 'None'){
                                                    $data .= '<div class="col-12 status-'.$current_effect.'" data-type="examination">';
                                                    $data .= '<span class="se_title">Notable examination findings at previous clinic visit</span>';
                                                        $data .= '<span class="se_status">';
