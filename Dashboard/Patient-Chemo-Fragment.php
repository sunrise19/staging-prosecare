                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM chemotherapy WHERE user_id = '$user_id'";
                            $result = $conn->query($sql);
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    $data .= '<div class="mb-5 side_effect_group" data-sort="'.strtotime($row['date']).'" data-day="'.$date[0].'" data-month="'.$date[1].'" data-year="'.$date[2].'">';
                                        ...
                                        if(strtolower($cancer) ==  'breast'){
                                            ...
                                            //CHEMO
                                            $current_effect = $row['chemo'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="chemo">';
                                                $data .= '<span class="se_title">Chemotherapy</span>';
                                            ...
                                            if(strtolower($current_effect = $row['chemo']) != 'no'){

                                                //CHEMO INDICATION
                                                $current_effect = $row['chemo_ind'];
                                                if($current_effect != 'None' && $current_effect != ''){
                                                    $data .= '<div class="col-12 status-'.$current_effect.'" data-type="chemo_ind">';
                                                    $data .= '<span class="se_title">Chemotherapy Indication</span>';
                                                        $data .= '<span class="se_status">';
                                                        $data .= $current_effect;
                                                        $data .= '</span>';
                                                    $data .= '</div>';
                                                ...
                                                //CHEMO REGIMEN
                                                $current_effect = $row['chemo_drug'];
                                                if($current_effect != 'None' && $current_effect != ''){
                                                    $data .= '<div class="col-12 status-'.$current_effect.'" data-type="chemo_drug">';
                                                    $data .= '<span class="se_title">Chemotherapy Regimen</span>';
                                                        $data .= '<div class="l2r" style="gap: 20px">';
                                                            $data .= '<div class="t2b w-100">';
                                                                $data .= '<span class="se_title">Drug Name</span>';
                                                                $data .= '<span class="se_status">' . $row['chemo_drug'] . '</span>';
                                                            $data .= '</div>';
                                                            $data .= '<div class="t2b w-100">';
                                                                $data .= '<span class="se_title">Dose</span>';
                                                                $data .= '<span class="se_status">' . $row['chemo_dose'] . '</span>';
                                                            $data .= '</div>';
                                                        $data .= '</div>';
                                                        $data .= '<div class="t2b">';
                                                            $data .= '<span class="se_title">Frequency</span>';
                                                            $data .= '<span class="se_status">' . $row['chemo_freq'] . '</span>';
                                                        $data .= '</div>';
                                                        // $data .= '<span class="se_status">';
                                                        // $data .= '&bull; ' . $row['chemo_drug'] . '<br>';
                                                        // $data .= '&bull; ' . $row['chemo_dose'] . '<br>';
                                                        // $data .= '&bull; ' . $row['chemo_freq'] . '<br>';
                                                        // $data .= '</span>';
                                                    $data .= '</div>';
                                                }
