                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM interruptions WHERE user_id = '$user_id'";
                            $result = $conn->query($sql);
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    $data .= '<div class="col-12 mb-5 side_effect_group" data-sort="'.strtotime($row['date']).'" data-day="'.$date[0].'" data-month="'.$date[1].'" data-year="'.$date[2].'">';
                                        ...
                                        $data .= '<div class="col-lg-12 col-sm-12">';
                                            ...
                                            if(strtolower($current_effect = $row['missed']) != 'no'){

                                                $current_effect = $row['reason'];
                                                if($current_effect != ''){
                                                    $data .= '<div class="col-12 status-'.$current_effect.'" data-type="surgery_type">';
                                                    $data .= '<span class="se_title">Reason for missed treatment</span>';
                                                        $data .= '<span class="se_status">';
                                                        $data .= $current_effect;
                                                        $data .= '</span>';
                                                    $data .= '</div>';
                                                ...
                                                $current_effect = $row['change'];
                                                if($current_effect != 'None' && $current_effect != ''){
                                                    $data .= '<div class="col-12 status-'.$current_effect.'" data-type="chemo_drug">';
                                                    $data .= '<span class="se_title">Change in Treatment Schedule</span>';
                                                        $data .= '<span class="se_status">';
                                                        $data .= $current_effect;
                                                        $data .= '</span>';
                                                    $data .= '</div>';
