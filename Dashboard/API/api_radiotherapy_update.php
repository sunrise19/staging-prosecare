<?php
    ...
    if(isset($_REQUEST["data"])){
        ...
        $sql = "SELECT * FROM radiotherapy WHERE radiotherapy_id='$id' AND user_id='$user_id' AND patient_id='$patient_id'";

        $result = mysqli_query($conn, $sql);

        if ($result->num_rows > 0) {

            $sql = "UPDATE radiotherapy SET 
            ...
            size_of_fractions='$size_of_fractions',  
            number_of_weeks='$number_of_weeks',  
            fractional_regimen='$fractional_regimen',  
            conventional='$conventional',  
            hypofractionation='$hypofractionation',  
            hyperfractionation='$hyperfractionation',  
            other='$other',  
            intent='$intent',  
            dose='$dose'
            WHERE radiotherapy_id='$id'";
