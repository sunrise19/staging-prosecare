<?php
    ...
    if(isset($_REQUEST["data"])){
        ...
        if ($result->num_rows > 0) {
            ...
            fp_loose_stool='$fp_loose_stool', 
            fp_nausea='$fp_nausea', 
            fp_vomiting='$fp_vomiting', 
            fp_skin_color='$fp_skin_color', 
            fp_anus_changes='$fp_anus_changes', 
            fp_blood_in_urine='$fp_blood_in_urine', 
            fp_diff_urinating='$fp_diff_urinating', 
            fp_painful_urine='$fp_painful_urine', 
            fp_feel_like_urine='$fp_feel_like_urine', 
            fp_urine_control='$fp_urine_control', 
            fp_urine_rate='$fp_urine_rate', 
            fp_vag_dry='$fp_vag_dry', 
            fp_stool_leak='$fp_stool_leak', 
            fp_tired_or_weak='$fp_tired_or_weak', 
            fp_weight='$fp_weight', 
            fp_note='$fp_note', 
            fp_on_chemo='$fp_on_chemo',
            treatment='$treatment'
