                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM supportive_care WHERE user_id = '$user_id'";
                            $result = $conn->query($sql);
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    $data .= '<div class="col-12 mb-5 side_effect_group" data-sort="'.strtotime($row['date']).'" data-day="'.$date[0].'" data-month="'.$date[1].'" data-year="'.$date[2].'">';
                                        ...
                                        if(strtolower($cancer) ==  'head and neck'){

                                            $current_effect = $row['hospital_admission'];
                                            if($current_effect != 'None'){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="hospital_admission">';
                                                $data .= '<span class="se_title">Reason for admission</span>';
                                            ...
                                            $current_effect = $row['day'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="day">';
                                                $data .= '<span class="se_title">Date admitted or discharged</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $row['day'] . ' ';
                                                    $data .= $row['month'] . ', ';
                                                    $data .= $row['year'];
                                            ...
                                            $current_effect = $row['due_to_side_effects'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="due_to_side_effects">';
                                                $data .= '<span class="se_title">Was this due to side effects?</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect;
                                                    $data .= '</span>';
                                                $data .= '</div>';
                                            ...
                                            $current_effect = $row['dietary_support'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="dietary_support">';
                                                $data .= '<span class="se_title">Dietary support</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect;
                                                    $data .= '</span>';
                                                $data .= '</div>';
                                            ...
                                            $current_effect = $row['gastronomy'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="gastronomy">';
                                                $data .= '<span class="se_title">Gastronomy</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect;
                                                    $data .= '</span>';
                                                $data .= '</div>';
                                            ...
                                            $current_effect = $row['PNT'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="PNT">';
                                                $data .= '<span class="se_title">PNT</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect;
                                                    $data .= '</span>';
                                                $data .= '</div>';
                                            ...
                                            $current_effect = $row['high_protein_diet'];
                                            if($current_effect != 'None' && $current_effect != ''){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="high_protein_diet">';
                                                $data .= '<span class="se_title">High Protein Diet</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect;
                                                    $data .= '</span>';
                                                $data .= '</div>';
                                            ...
                                            $current_effect = $row['dental_care'];
                                            if($current_effect != 'None'){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="dental_care">';
                                                $data .= '<span class="se_title">Pre-radiotherapy dental care</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect != '' ? $current_effect : '-';
                                                    $data .= '</span>';
                                                $data .= '</div>';
                                            }
                                            
                                            $current_effect = $row['tips'];
                                            if($current_effect != 'None'){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="tips">';
                                                $data .= '<span class="se_title">Did you receive oral hygiene tips and care from the dentist prior to radiotherapy?</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect != '' ? $current_effect : '-';
                                                    $data .= '</span>';
                                                $data .= '</div>';
                                            ...
                                            $current_effect = $row['tube'];
                                            if($current_effect != 'None'){
                                                $data .= '<div class="col-12 status-'.$current_effect.'" data-type="tube">';
                                                $data .= '<span class="se_title">Feeding gastrostomy tube insertion</span>';
                                                    $data .= '<span class="se_status">';
                                                    $data .= $current_effect != '' ? $current_effect : '-';
                                                    $data .= '</span>';
                                                $data .= '</div>';
