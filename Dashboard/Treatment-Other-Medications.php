...
?>
    ...
    <style>
        ...
        .add_new_drug,.add_new_drug:hover{
                    ...
                    <div class="row d-none">
                        <div class="col-12">
                            <div class="page-title-box d-flex justify-content-between flex-column">
                                <h2 class="mb-0 snt font-weight-bold">Log Other Medications</h2>
                                <br>
                                <h5 class="mb-0 snt font-size-15 font-weight-normal" style="color: #666">Log your Other Medications here. Click on a day to begin</h5>
                        ...
                        <div class="card m-0" style="flex: 1; height: 100vh; box-shadow: none">
                            <div class="card-body">
                                ...
                                <div class="side_effect_items" style="display: none">
                                    ...
                                    <!-- <p class="card-title font-size-20 mb-2 current-state align-center" style="text-transform: none">Log Other Medications</p> -->
                                    <h5 class="mb-4 snt font-size-15 font-weight-normal sub-state" style="color: #000">No other medications has been logged today. Log them below</h5>
                                    ...
                                    <div class="t2b as_sheet">
                                        <div class="drugs_holder" style="width: calc(100% - 26px)">
                                            ...
                                            <div class="drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                                ...
                                                <div class="flex flex_row simple_flex">
                                                    <input type="text" placeholder="Drug" class="drug_name">
                                                </div>
                                        ...
                                        <div class="d-flex flex-row justify-content-end">
                                            <button class="btn-outline-primary mt-4 add_new_drug">New Drug</button>
                                        </div>
                                    </div>

                                    

                                    <button class="btn-primary btn-lg mt-4" id="add-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%);">Log Other Medications</button>
                                    <button class="btn-primary btn-lg mt-4" id="update-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%); display: none">Update Other Medications</button>
    ...
    <script src="JS/LogOtherMedications.js"></script>
    <script>
