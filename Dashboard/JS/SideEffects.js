$(document).ready(function() {
    ...
    $('.report_side_effect,.start_log').on('click', function(){
        ...
        $('.side_effects_graph,.tab_holder,.right_actions,.edit_side_effects').addClass('d-none')
    ...
    $('.go_back').on('click', function(){
        ...
        $('.side_effects_graph,.tab_holder,.right_actions,.edit_side_effects').removeClass('d-none')
    ...
    $('#add-data').on('click', function() {
        ...
        if(CANCER_TYPE == 'breast'){
            ...
            var b_hair_loss = $('#b_hair_loss').val(),
                ...
                b_breast_swelling = $('#b_breast_swelling').val() == 'other' ? $('#b_breast_swelling_other').val() : $('#b_breast_swelling').val(),
            ...
            */
            ...
            var formData = [b_hair_loss, b_arm_swelling, b_swallowing_difficulty, b_chest_pain, b_breast_swelling, b_breast_pain, b_sensation_loss, b_skin_color, b_tired_or_weak, b_weight, b_hb, b_pcv, b_anc, b_platelet, b_note, b_wbc, SELECTED_DATE, treatment_type, feeling]
            ...
            var hn_mouth_sore = $('#hn_mouth_sore').val(),
                ...
                hn_loss_of_smell = $('#hn_loss_of_smell').val() == 'other' ? $('#hn_loss_of_smell_other').val() : $('#hn_loss_of_smell').val(),
                hn_taste_changes = $('#hn_taste_changes').val(),
                hn_dry_mouth = $('#hn_dry_mouth').val(),
                hn_mouth_cracking = $('#hn_mouth_cracking').val() == 'other' ? $('#hn_mouth_cracking_other').val() : $('#hn_mouth_cracking').val(),
                hn_voice_change = $('#hn_voice_change').val(),
                hn_appetite_changes = $('#hn_appetite_changes').val(),
                hn_nausea = $('#hn_nausea').val() == 'other' ? $('#hn_nausea_other').val() : $('#hn_nausea').val(),
            ...
            */
            ...
            var formData = [hn_mouth_sore, hn_diff_in_swallowing, hn_loss_of_smell, hn_taste_changes, hn_dry_mouth, hn_mouth_cracking, hn_voice_change, hn_appetite_changes, hn_nausea, hn_vomiting, hn_skin_color_changes, hn_tired_or_weak, hn_weight, hn_note, hn_on_chemo, SELECTED_DATE, treatment_type, feeling]
            ...
            var fp_loose_stool = $('#fp_loose_stool').val(),
                fp_nausea = $('#fp_nausea').val() == 'other' ? $('#fp_nausea_other').val() : $('#fp_nausea').val(),
            ...
            */
            ...
            var formData = [fp_loose_stool, fp_nausea, fp_vomiting, fp_skin_color, fp_anus_changes, fp_blood_in_urine, fp_diff_urinating, fp_painful_urine, fp_feel_like_urine, fp_urine_control, fp_urine_rate, fp_vag_dry, fp_stool_leak, fp_tired_or_weak, fp_weight, fp_note, fp_on_chemo, SELECTED_DATE, treatment_type, feeling]
            ...
            var mp_blood_in_urine = $('#mp_blood_in_urine').val(),
                ...
                mp_nausea = $('#mp_nausea').val() == 'other' ? $('#mp_nausea_other').val() : $('#mp_nausea').val(),
                ...
                mp_belly_tight = $('#mp_belly_tight').val() == 'other' ? $('#mp_belly_tight_other').val() : $('#mp_belly_tight').val(),
                mp_stool_leak = $('#mp_stool_leak').val(),
                mp_erection = $('#mp_erection').val() == 'other' ? $('#mp_erection_other').val() : $('#mp_erection').val(),
                mp_diff_in_releases = $('#mp_diff_in_releases').val() == 'other' ? $('#mp_diff_in_releases_other').val() : $('#mp_diff_in_releases').val(),
                mp_decreased_desire = $('#mp_decreased_desire').val() == 'other' ? $('#mp_decreased_desire_other').val() : $('#mp_decreased_desire').val(),
                mp_painful_sex = $('#mp_painful_sex').val() == 'other' ? $('#mp_painful_sex_other').val() : $('#mp_painful_sex').val(),
            ...
            */
            ...
            var formData = [mp_blood_in_urine, mp_diff_urinating, mp_painful_urine, mp_urine_rate, mp_feel_like_urine, mp_urine_control, mp_nausea, mp_vomiting, mp_loose_stool, mp_anus_changes, mp_blood_from_anus, mp_diff_stooling, mp_belly_tight, mp_stool_leak, mp_erection, mp_diff_in_releases, mp_decreased_desire, mp_painful_sex, mp_tired_or_weak, mp_weight, mp_note, mp_on_chemo, SELECTED_DATE, treatment_type, feeling]
    ...
    $('#update-data').on('click', function() {
        ...
        if(CANCER_TYPE == 'breast'){
            ...
            */
            ...
            var formData = [b_hair_loss, b_arm_swelling, b_swallowing_difficulty, b_chest_pain, b_breast_swelling, b_breast_pain, b_sensation_loss, b_skin_color, b_tired_or_weak, b_weight, b_hb, b_pcv, b_anc, b_platelet, b_note, b_wbc, SELECTED_DATE, ACTIVE_SIDE_EFFECT_ID, treatment_type]
            ...
            */
            ...
            var formData = [hn_mouth_sore, hn_diff_in_swallowing, hn_loss_of_smell, hn_taste_changes, hn_dry_mouth, hn_mouth_cracking, hn_voice_change, hn_appetite_changes, hn_nausea, hn_vomiting, hn_skin_color_changes, hn_tired_or_weak, hn_weight, hn_note, hn_on_chemo, SELECTED_DATE, ACTIVE_SIDE_EFFECT_ID, treatment_type]
            ...
            */
            ...
            var formData = [fp_loose_stool, fp_nausea, fp_vomiting, fp_skin_color, fp_anus_changes, fp_blood_in_urine, fp_diff_urinating, fp_painful_urine, fp_feel_like_urine, fp_urine_control, fp_urine_rate, fp_vag_dry, fp_stool_leak, fp_tired_or_weak, fp_weight, fp_note, fp_on_chemo, SELECTED_DATE, ACTIVE_SIDE_EFFECT_ID, treatment_type]
            ...
            */
            ...
            var formData = [mp_blood_in_urine, mp_diff_urinating, mp_painful_urine, mp_urine_rate, mp_feel_like_urine, mp_urine_control, mp_nausea, mp_vomiting, mp_loose_stool, mp_anus_changes, mp_blood_from_anus, mp_diff_stooling, mp_belly_tight, mp_stool_leak, mp_erection, mp_diff_in_releases, mp_decreased_desire, mp_painful_sex, mp_tired_or_weak, mp_weight, mp_note, mp_on_chemo, SELECTED_DATE, ACTIVE_SIDE_EFFECT_ID, treatment_type]
    ...
    function clearForm() {
        ...
        $('.sub-state').html('No side effects have been logged today. Log them below')
        $('input,textarea').val('')
