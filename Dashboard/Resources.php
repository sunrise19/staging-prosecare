            ...
            <div class="page-content" style=" padding-bottom: 0; ">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h2 class="mb-0 snt" style=" font-weight: 600; color: #000; ">Resources</h2>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->        
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12" style="cursor: pointer" onclick="window.open('Article-Advancements-In-Immunotherapy', '_self')">
                        ...
                        <div class="col-md-4 col-sm-12 d-none" style="cursor: pointer">
                            <div class="card mini-stats-wid" style="background-image: url(../assets/images/emotional.png)">
                                <div class="card-body">
                                    <div class="media flex-column">
                                        <div class="shaded_glass"></div>
                                        <div class="media-body">
                                            ...
                                            <h4 class="glass_text">Cancer Care</h4>
                                            <h4 class="mb-3 font-size-20 text-white">Emotional Journey of a Cancer Diagnosis</h4>
                                            <h4 class="mb-2 font-size-17 text-white"><u>WATCH VIDEO</u></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
