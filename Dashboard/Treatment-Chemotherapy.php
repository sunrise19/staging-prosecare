...
?>
                    ...
                    <div class="row d-none">
                        <div class="col-12">
                            <div class="page-title-box d-flex justify-content-between flex-column">
                                <h2 class="mb-0 snt font-weight-bold">Log Chemotherapy</h2>
                                <br>
                                <h5 class="mb-0 snt font-size-15 font-weight-normal" style="color: #666">Log your chemotherapy here. Click on a day to begin</h5>
                        ...
                        <div class="card m-0" style="flex: 1; height: 100vh; box-shadow: none">
                            <div class="card-body">
                                ...
                                <div class="side_effect_items" style="display: none">
                                    ...
                                    <!-- <p class="card-title font-size-20 mb-2 current-state align-center" style="text-transform: none">Log Chemotherapy</p> -->
                                    <h5 class="mb-4 snt font-size-15 font-weight-normal sub-state" style="color: #000">No chemotherapy have been logged today. Log them below</h5>
                                    ...
                                    <div class="t2b as_sheet">
                                        ...
                                        <div class="drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic">
                                            <label class="i-g-block-label">Chemotherapy</label>
                                            <span style=" position: absolute; right: 10px; top: 34px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select visibility_controller" id="b_chemo">
                                        ...
                                        <div class="mt-3 drop_d to_remove type_breast show_on_change">
                                            <label class="i-g-block-label">Chemotherapy indication</label>
                                            <span style=" position: absolute; right: 10px; bottom: 14px; font-size: 20px">&#8964;</span>
                                            <select class="sweetselect sfx_select" id="b_chemo_ind">
                                                <option value="" selected disabled>Select an option</option>
                                        ...
                                        <div class="mt-3 drop_d to_remove type_male_pelvic show_on_change">
                                            ...
                                            <select class="sweetselect sfx_select" id="b_chemo_ind">
                                                <option value="" selected disabled>Select an option</option>
                                                <option value="Concurrent Chemoradiation">Concurrent Chemoradiation</option>
                                                <option value="Adjuvant">Adjuvant</option>
                                    ...
                                    <div class="t2b as_sheet show_on_change">

                                        <span class="mt-3 drop_separator show_on_change">Chemotherapy regimen</span>
    
                                        <div class="l2r">

                                            <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic show_on_change">
                                                <label class="i-g-block-label">Drug name</label>
                                                <div class="flex flex_row simple_flex">
                                                    <input type="text" placeholder="Enter Drug name here" id="b_chemo_drug">
                                                </div>
                                            </div>
        
                                            <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic show_on_change">
                                                <label class="i-g-block-label">Dose</label>
                                                <div class="flex flex_row simple_flex">
                                                    <input type="text" placeholder="Enter Dose here" id="b_chemo_dose">
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-3 drop_d to_remove type_breast type_head_and_neck type_male_pelvic type_female_pelvic show_on_change">
                                            <label class="i-g-block-label">Frequency</label>
                                            <div class="flex flex_row simple_flex">
                                                <input type="text" placeholder="Enter Frequency here" id="b_chemo_freq">
                                            </div>
                                        </div>
                                    ...
                                    <button class="btn-primary btn-lg mt-4" id="add-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%);">Log Chemotherapy</button>
                                    <button class="btn-primary btn-lg mt-4" id="update-data" style="padding: 13px 30px !important;font-size: 15px !important;border-radius: 50px !important;margin: 0 auto 25px;left: 50%;position: relative;transform: translateX(-50%); display: none">Update Chemotherapy</button>
    ...
    <script src="JS/LogChemotherapy.js"></script>
    <script>
