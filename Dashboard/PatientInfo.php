...
<div class="main-content">
    ...
    <div class="page-content p-3">
        <div class="container-fluid">
            ...
            <i onclick="window.location.href='<?php echo isset($_SESSION['superadmin']) ? 'Hospital-' : ''; ?>Patients'" class="bx bx-left-arrow-alt mb-4" style=" cursor: pointer; background: #8D2D9217; color: #8D2D92; font-size: 23px; padding: 10px; border-radius: 50px; "></i>

            <h2 class="mb-0 snt" style=" font-weight: 600; color: #000; ">Patient Info</h2>


            <div class="l2r mt-5 <?php echo isset($_SESSION['superadmin']) ? 'd-none' : ''; ?>" style="gap: 70px; justify-content: start;">
                <a class="tab_item active" data-tab="profile">Profile</a>
                <a class="tab_item" data-tab="side_effects">Side Effects</a>
            ...
            <div class="tab_container profile" style="display: block">
                ...
                <div class="t2b as_sheet mt-4 p-0 border-0 <?php echo (isset($_SESSION['hospital']) || isset($_SESSION['superadmin'])) ? '' : 'd-none' ?>" style="background: none;">
                    ...
                    <div class="l2r" style="gap: 25px; align-items: center;">
                        ...
                        <div class="t2b" style="gap: 20px;">
                            <div class="l2r">
                                <div class="t2b" style="gap: 1px">
                                    <span class="font-size-18 font-weight-bold text-dark"><?php echo $data['first_name'] . ' ' . $data['last_name'] ?></span>
                                    <div class="cell_title font-size-15">
                                        Assigned to:
                                        <?php

                                        $assigned_hcp = $data['assigned_hcp'];
                                        ...
                                        if ($assigned_hcp != 0) {
                                            ...
                                            if ($resultDoc->num_rows > 0) {
                                                while ($rowDoc = $resultDoc->fetch_assoc()) {
                                                    echo '<span class="text-primary font-weight-bold" onclick="window.open(\'./DoctorInfo?ID=' . $assigned_hcp . '\', \'_self\')">' . ucwords('Dr. ' . $rowDoc['first_name'] . ' ' . $rowDoc['last_name']) . '</span>';
                                                }
                                            }
                                        } else {
                                            echo '-';
                        ...
                        <div class="action_button accept assign_patient <?php echo isset($_SESSION['superadmin']) ? 'd-none' : '' ?>"><i class="bx bx-pencil font-size-17 mr-2"></i> Assign</div>
                        <div class="action_button accept <?php echo isset($_SESSION['superadmin']) ? '' : 'd-none' ?>" onclick="window.location.href='QualityOfLifeResults?ID=<?php echo $UID?>'"><i class="bx bx-file font-size-17 mr-2"></i> View QOL Results</div>
                    </div>
                    <!-- END PROFILE HEADING -->
                </div>
                ...
                <div class="mt-4 t2b as_sheet">
                    ...
                    <div class="l2r" style="gap: 25px">
                        <div class="photo_box <?php echo (isset($_SESSION['hospital']) || isset($_SESSION['superadmin'])) ? 'd-none' : '' ?>">
                            <img src="IMG/<?php echo $data['photo'] ?>" alt="">
                        </div>
                        <div class="t2b" style="gap: 36px;">
                            <div class="l2r">
                                <div class="t2b cell">
                                    <div class="cell_title">Patient ID</div>
                                    <div class="cell_value">#<?php echo $data['patient_id'] ?></div>
                                </div>
                                <div class="t2b cell">
                                    <div class="cell_title">Full Name</div>
                                    <div class="cell_value"><?php echo $data['first_name'] . ' ' . $data['last_name'] ?></div>
                                </div>
                                <div class="t2b cell" <?php echo !isset($_SESSION['superadmin']) ? '' : 'style=" width: 40%; "' ?> >
                                ...
                                <div class="t2b cell <?php echo isset($_SESSION['superadmin']) ? 'd-none' : ''?>">
                                    <div class="cell_title">PIN</div>
                                    <div class="cell_value"><?php echo getInitials(str_replace("and", "",$data['cancer'])).$data['user_id'] ?></div>
                                </div>
                            </div>
                            <div class="l2r">
                                <div class="t2b cell">
                                ...
                                <div class="t2b cell">
                                    <div class="cell_title">Date of Birth</div>
                                    <div class="cell_value"><?php echo $data['day'] . '-' . $data['month'] . '-' . $data['year'] ?></div>
                                </div>
                                <div class="t2b cell" style="width: 40%">
                                    <div class="cell_title">Address</div>
                                    <div class="cell_value"><?php echo $data['address'] . ', ' . $data['lga'] . ', ' . $data['state'] . ', ' . $data['country'] ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="l2r mt-4">
                    ...
                    <div class="col-12 p-0" style=" display: flex; gap: 24px; ">

                        <div class="p-4 flex-1 as_sheet" style="background: #F9F9F9; border-radius: 10px;">
                        ...
                        <div class="p-4 as_sheet" style="background: #F9F9F9; border-radius: 10px; width: 35%">
                            <span class="section_title">Health Report</span>
                            <?php

                                $sql = "SELECT * FROM sideeffects WHERE user_id='$user_id' ORDER BY sideeffects_id DESC LIMIT 1";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        $lastSideEffects = $row['date_added'];
                                    }
                                }

                                $sql = "SELECT * FROM interruptions WHERE user_id='$user_id' ORDER BY interruption_id DESC LIMIT 1";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        $lastTreatment = $row['date_added'];
                                    }
                                }
                            ?>
                            <div class="t2b as_sheet" style="height: unset; background: #fff">
                                <span>Last side effect reported on:</span>
                                <h4 class="text-primary m-0"><?php echo $lastSideEffects;?></h4>
                            </div>
                            <div class="t2b as_sheet mt-3" style="height: unset; background: #fff">
                                <span>Last treatment logged on:</span>
                                <h4 class="text-primary m-0"><?php echo $lastTreatment;?></h4>
                            </div>
                        </div>
                ...
                <div class="mt-4 t2b as_sheet <?php echo isset($_SESSION['superadmin']) ? 'd-none' : ''; ?>">
                    ...
                    <div class="l2r" style="gap: 25px">
                        <div class="t2b" style="gap: 36px;">
                            ...
                            <div class="l2r">
                                ...
                                <div class="t2b cell" style="width: 40%">
                                    <div class="cell_title">Date of Birth</div>
                                    <div class="cell_value"><?php echo $dataNOK['dob'] ?></div>
                                </div>
                                <div class="t2b cell" style="width: 40%">
                                    <div class="cell_title">Address</div>
                ...
                <!--
                <div class="mt-4 t2b as_sheet <?php echo isset($_SESSION['superadmin']) ? 'd-none' : ''; ?>">
                    <div class="small_title">Caregiver</div>
                    <div class="l2r" style="gap: 25px">
                        <div class="t2b" style="gap: 36px;">
                            <div class="l2r">
                                <div class="t2b cell">
                                    <div class="cell_title">Full Name</div>
                                    <div class="cell_value">Blessing Oladipupo</div>
                                </div>
                                <div class="t2b cell" style="width: 40%">
                                    <div class="cell_title">Email Address</div>
                                    <div class="cell_value">blessingoladipupo@gmail.com</div>
                                </div>
                                <div class="t2b cell">
                                    <div class="cell_title">Phone Number</div>
                                    <div class="cell_value">+234 8102345678</div>
                                </div>
                            </div>
                            <div class="l2r">
                                <div class="t2b cell">
                                    <div class="cell_title">Gender</div>
                                    <div class="cell_value">Female</div>
                                </div>
                                <div class="t2b cell" style="width: 40%">
                                    <div class="cell_title">Date of Birth</div>
                                    <div class="cell_value">22-05-1998</div>
                                </div>
                                <div class="t2b cell" style="width: 40%">
                                    <div class="cell_title">Address</div>
                                    <div class="cell_value">Wuse 11, abuja plaza, 456789, Abuja, Nigeria</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4 t2b as_sheet <?php echo isset($_SESSION['superadmin']) ? 'd-none' : ''; ?>">
                    <div class="small_title">Disease Characteristics</div>
                    <div class="l2r" style="gap: 25px">
                        <div class="t2b" style="gap: 36px;">
                            <div class="l2r" style="gap: 20px">
                                <div class="t2b cell" style=" flex: 1; ">
                                    <div class="cell_title">Age Diagnosed</div>
                                    <div class="cell_value"><?php echo $data['age_when_diagnosed'] ?></div>
                                </div>
                                <div class="t2b cell" style=" flex: 1; ">
                                    <div class="cell_title">Inital Cancer</div>
                                    <div class="cell_value"><?php echo $data['age_when_diagnosed'] ?> Cancer</div>
                                </div>
                                <div class="t2b cell" style=" flex: 1; ">
                                    <div class="cell_title">Cancer Stage</div>
                                    <div class="cell_value"><?php echo $data['cancer_stage'] ?></div>
                                </div>
                                <div class="t2b cell" style=" flex: 1; ">
                                    <div class="cell_title">Histology Type</div>
                                    <div class="cell_value"><?php echo $data['histology'] ?></div>
                                </div>
                                <div class="t2b cell" style=" flex: 1; ">
                                    <div class="cell_title">Cancer Grade</div>
                                    <div class="cell_value"><?php echo $data['cancer_grade'] ?></div>
                                </div>
                                <div class="t2b cell" style=" flex: 1; ">
                                    <div class="cell_title">Comorbidity</div>
                                    <div class="cell_value"><?php echo $data['comorbidity'] ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab_container side_effects">

                <div class="mt-4 as_sheet">
                    <div class="l2r" style="align-items: center; justify-content: space-between">
                        ...
                        <div class="prose_dropdown l2r" style="width: unset">
                            <select class="prose_select" style=" border: 1px solid; " data-default="<?php echo explode(" ", $_REQUEST['SORT'])[0]?>" onchange="updateURLWithSort(this.value)">
                    ...
                    <div class="l2r mt-3 d-none" style=" gap: 35px; ">
                    ...
                    $sql = "SELECT * FROM sideeffects WHERE patient_id='$UID'";
                        ...
                        <div class="card-body d-flex p-0 align-items-center w-100">
                            ...
                            <div class="empty_state w-100">
                                <div>
                                    ...
                                    <h5 class="mt-2 mb-0 snt font-size-15 font-weight-normal es_message" style="color: #666">Click on a day to view logs</h5>
                                    <!-- <button class="btn btn-primary start_log mt-3" style="display: none">Add New Log</button> -->
                                </div>
                            </div>

                            <div class="side_effect_items w-100" style="display: none">
            ...
            <div class="tab_container treatments">
                ...
                <div class="l2r mt-4" style="gap: 25px">
                    <div class="l2r treatment_item" data-frame="Patient-Chemo-Fragment">
                        <img src="IMG/chemo.svg" alt="">
                        Chemotherapy
                    </div>
                    <div class="l2r treatment_item" data-frame="Patient-Radio-Fragment">
                        <img src="IMG/radio.svg" alt="">
                        Radiotherapy
                    </div>
                    <div class="l2r treatment_item" data-frame="Patient-Interruption-Fragment">
                ...
                <div class="l2r mt-4" style="gap: 25px">
                    <div class="l2r treatment_item" data-frame="Patient-Other-Medication-Fragment">
                        <img src="IMG/treat.png" alt="">
                        Other Medications
                    </div>
                    <div class="l2r treatment_item" data-frame="Patient-Surgery-Fragment">
                        <img src="IMG/surg.png" alt="">
                        Surgical Procedure
                    </div>
                    <div class="l2r treatment_item" data-frame="Patient-Support-Fragment">
    ...
    <script>
        ...
        $(document).ready(function(){
            if(window.location.href?.includes('SORT=Weakness')){
                $('[data-tab="side_effects"]').click()
            }
        })
        ...
        $(document).ready(function(){
            if(window.location.href?.includes('Clear')){
                $('#page-topbar,.vertical-menu,.bx-left-arrow-alt,.snt').remove()
                $('.main-content').css('margin-left', 0)
                $('.l2r.mt-5').removeClass('mt-5').addClass('mt-2')
                $('.page-content').removeClass('p-3').addClass('p-0').addClass('pb-3')
                $('.container-fluid').css('padding', 0)

                $('.treament_modal').css({'border-radius': '10px'})
            }
        })
    </script>
