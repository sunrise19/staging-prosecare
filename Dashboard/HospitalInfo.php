...
$sql = "SELECT * FROM hospitals JOIN users ON hospitals.user_id=users.user_id WHERE hospitals.user_id='$UID'";
...
<div class="main-content">
    ...
    <div class="page-content p-3">
        <div class="container-fluid">
            ...
            <div class="l2r mb-1" style="gap: 30px">


                <i onclick="window.location.href='./Hospitals'" class="bx bx-left-arrow-alt mb-4" style=" cursor: pointer; background: #8D2D9217; color: #8D2D92; font-size: 23px; padding: 10px; border-radius: 50px; "></i>
            ...
            <h2 class="mb-4 snt" style=" font-weight: 600; color: #000; ">Hospital Info</h2>
                ...
                <div class="mt-4 t2b as_sheet">
                    ...
                    <div class="p-0 w-100 border-0" style="background: #F9F9F9; border-radius: 10px; border: 1px solid #0000000D; text-align: left">
                        <div class="l2r" style="gap: 10px; align-items: center;">
                            <img src="IMG/<?php echo $data['photo']; ?>" alt="" style="width: 60px; height: 60px; object-fit: cover; border-radius: 100px; border: 1px solid #8D2D922B">
                            <div class="t2b">
                                <h3 class="font-weight-bold text-dark mb-0 flex-1"><?php echo $data['name']; ?></h3>
                                <h6 class="text-dark mt-1 mb-0 flex-1">Created On: <?php echo $data['signup_date']; ?></h6>
                            </div>
                            <div class="l2r flex-1 justify-content-end" style="gap: 15px">
                                <div class="action_button accept reset_password">Reset Password</div>
                                <div class="action_button decline deactivate <?php echo $data['active'] == 'false' ? 'd-none' : '' ?>">Deactivate</div>
                                <div class="action_button accept activate <?php echo $data['active'] == 'true' ? 'd-none' : '' ?>">Activate</div>
                            </div>
                        </div>

                        <div class="row w-100 mx-0 my-3 pt-4 pb-1 px-0" style="border-top: 1px solid #14142B29; border-bottom: 1px solid #14142B29">
                            ...
                            <div class="col-md-3 col-sm-12 px-1" onclick="location.href = './Patients'">
                            ...
                            <div class="col-md-3 col-sm-12 px-1" onclick="location.href = './Doctors'">
                                <div class="card mini-stats-wid home_outlined_card mb-0">
                                    <div class="card-body py-0">
                                        <div class="media flex-row">
                                            <div class="media-body align-items-center">
                                    ...
                                    <div class="card-body py-0">
                                        <div class="media flex-row">
                                            <div class="media-body align-items-center">
                                                ...
                                                <p class="font-weight-medium font-size-14 my-3" style="color: #000; text-transform: none">HCPs taking the course</p>
                                                <h4 class="mb-1 font-weight-bold" style="color: #57166A; font-size: 35px">
                                                    <?php
                                                    $sql = "SELECT count(1) FROM starpipe_progress JOIN hcp ON starpipe_progress.user_id=hcp.user_id WHERE hcp.hospital='$hospital_id' GROUP BY starpipe_progress.user_id";
                                                    $result = mysqli_query($conn, $sql);
                                                    $row = mysqli_fetch_array($result);
                                                    echo number_format($row[0]);
                                                    ?>
                        ...
                        <div class="l2r text-dark align-start" style="gap: 10px;">
                            ...
                            <span class="flex-1 font-size-14">
                                <?php echo $data['address'] . ', ' . $data['lga'] . ', ' . $data['state'] ?>
                            </span>
                        </div>
                        <div class="l2r text-dark mt-4" style="gap: 10px;">
                            <div class="l2r flex-1" style="gap: 10px">
                                ...
                                <div class="card-body py-0" style="background: #e9d9e9 !important">
                                    <div class="media flex-row">
                                        <div class="media-body align-items-center pt-5">
                                            <img src="../assets/images/Trash_Full.svg" style="background: #fff;padding: 10px;border-radius: 30px; right: 0; top: 0; position: absolute">
                                            <p class="font-weight-bold font-size-15 mb-1 mt-5" style="color: #000; text-transform: none">0213049876</p>
                                            <p class="font-weight-medium font-size-15 mb-1" style="color: #000; text-transform: none">Rjolad hospital</p>
                                            <p class="font-weight-medium font-size-15 mb-1" style="color: #000; text-transform: none">GT Bank</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
        ...
        $('.action_button.deactivate').on('click', function() {
            Swal.fire({
                ...
                html: '<?php echo $data['name'] ?> will be deactivated.',
                type: 'warning',
                showCancelButton: !0,
                ...
                t.value ? actionHospital('Deactivate') : t.dismiss === Swal.DismissReason.cancel
            })
        })

        $('.action_button.activate').on('click', function() {
            Swal.fire({
                title: 'Activate Hospital',
                html: '<?php echo $data['name'] ?> will be activated.',
                type: 'warning',
                showCancelButton: !0,
                confirmButtonText: 'Deactivate',
                cancelButtonText: 'Cancel',
                ...
                t.value ? actionHospital('Activate') : t.dismiss === Swal.DismissReason.cancel
            })
        })
        ...
        $('.action_button.accept').on('click', function() {
            Swal.fire({
                ...
                html: 'Password will be reset for <?php echo $data['name'] ?>',
                type: 'warning',
                showCancelButton: !0,
                ...
                t.value ? actionReset() : t.dismiss === Swal.DismissReason.cancel
            })
        })
        ...
        function actionReset() {
            ...
            $.ajax({
                async: false,
                url: './API/api_reset.php?id=' + <?php echo $user_id ?>,
                type: 'POST',
                success: function(data) {
                    if (data == 1) {
                        s('Password successfully reset to Password@123')
                    } else {
